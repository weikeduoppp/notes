...
## [#](https://www.cxymsg.com/guide/react.html#react的请求应该放在哪个生命周期中)React的请求应该放在哪个生命周期中?
...
## [#](https://www.cxymsg.com/guide/react.html#setstate到底是异步还是同步)setState到底是异步还是同步?
...
## [#](https://www.cxymsg.com/guide/react.html#react组件通信如何实现)React组件通信如何实现?
...
## [#](https://www.cxymsg.com/guide/react.html#react有哪些优化性能是手段)React有哪些优化性能是手段?

性能优化的手段很多时候是通用的详情见[前端性能优化加载篇](https://www.cxymsg.com/guide/load.html)

## [#](https://www.cxymsg.com/guide/react.html#react如何进行组件-逻辑复用)React如何进行组件/逻辑复用?
...
## [#](https://www.cxymsg.com/guide/react.html#mixin、hoc、render-props、react-hooks的优劣如何？)mixin、hoc、render props、react-hooks的优劣如何？
...
## [#](https://www.cxymsg.com/guide/react.html#你是如何理解fiber的)你是如何理解fiber的?
...
## [#](https://www.cxymsg.com/guide/react.html#你对-time-slice的理解)你对 Time Slice的理解?
...
## [#](https://www.cxymsg.com/guide/react.html#redux的工作流程)redux的工作流程?
...
## [#](https://www.cxymsg.com/guide/react.html#react-redux是如何工作的)react-redux是如何工作的?
...
## [#](https://www.cxymsg.com/guide/react.html#redux与mobx的区别)redux与mobx的区别?
...
## [#](https://www.cxymsg.com/guide/react.html#redux中如何进行异步操作)redux中如何进行异步操作?
...
## [#](https://www.cxymsg.com/guide/react.html#redux异步中间件之间的优劣)redux异步中间件之间的优劣?
...
- 请简述你对react的理解。 （字节）
- 说一下 HTML5 drag api （阿里）
- cookie session 区别？ （阿里）
- 说说对HTLM语义化标签的理解。 （腾讯）
- JS中的垃圾回收机制？ （百度）
- Vue跨域的解决方式？ （字节）
- CSS 选择器有哪些，优先级呢？ （阿里）
