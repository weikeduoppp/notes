...
// 深拷贝
    ...
    function clone(target, map = new WeakMap()) {
      if (typeof target === "object" && Object.prototype.toString.call(target) !== '[object RegExp]') {
...
// 克隆正则 Object.prototype.toString.call(a.c)
...
pop(返回删除的值)`、`push`(返回数组长度)、`shift`、`unshift`、`reverse`、`sort`、`splice`、`fill`、`copyWithin
